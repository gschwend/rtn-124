...
the LSDB package \citep{2025arXiv250102103C} enables loading large datasets with limited memory, performing efficent all-sky analysis, and fast cross matching to other surveys like DESI DR1 and Gaia DR3.

The photo-z point estimates (mean, mode, median and ``best''), 1 and 2 sigma redshift intervals for DP2 object catalog are served as tabular catalogs in the HATS format.
